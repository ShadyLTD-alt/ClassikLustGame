...
export default function CharacterEditor({ character, isEditing = false, onSuccess, onCancel }: CharacterEditorProps) {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-4 bg-gray-800/50">
              <TabsTrigger value="basic" className="text-white data-[state=active]:bg-purple-600">Basic Info</TabsTrigger>
              <TabsTrigger value="personality" className="text-white data-[state=active]:bg-purple-600">Personality</TabsTrigger>
              <TabsTrigger value="advanced" className="text-white data-[state=active]:bg-purple-600">Advanced</TabsTrigger>
              <TabsTrigger value="ai" className="text-white data-[state=active]:bg-purple-600">AI Behavior</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="basic" className="space-y-4">
              <Card className="bg-gray-800/50 border-gray-600">
                <CardHeader>
                  <CardTitle className="text-white">Basic Character Information</CardTitle>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-white">Required Level to Unlock</FormLabel>
                          <FormControl>
                            <Input 
                              type="number" 
                              min="1" 
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-white">Base Personality</FormLabel>
                          <FormControl>
                            <Select onValueChange={field.onChange} value={field.value}>
                              <SelectTrigger className="bg-gray-700 border-gray-600 text-white">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border border-gray-600 p-4 bg-gray-700/50">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base text-white">VIP Character</FormLabel>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border border-gray-600 p-4 bg-gray-700/50">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base text-white">NSFW Content</FormLabel>
                            <FormDescription className="text-gray-400">
                              18+ content allowed
                            </FormDescription>
                          </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border border-gray-600 p-4 bg-gray-700/50">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base text-white">Wheel Reward</FormLabel>
                            <FormDescription className="text-gray-400">
            ...
            <TabsContent value="ai" className="space-y-4">
              <Card className="bg-gray-800/50 border-gray-600">
                <CardHeader>
                  <CardTitle className="text-white">AI Behavior Configuration</CardTitle>
                  <CardDescription className="text-gray-400">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-white">Response Timing</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField
                        control={form.control}
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-white">Min Response Time (seconds)</FormLabel>
                            <FormControl>
                              <Input 
                                type="number" 
                                min="1" 
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-white">Max Response Time (seconds)</FormLabel>
                            <FormControl>
                              <Input 
                                type="number" 
                                min="1" 
                  ...
                  {/* Custom Greetings */}
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-white">Custom Greetings</h4>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {form.watch("customGreetings")?.map((greeting, index) => (
                        <div key={index} className="bg-purple-600/20 border border-purple-500 rounded-md px-3 py-1 text-sm text-white">
                          {greeting}
                        </div>
                      ))}
                    </div>
                  ...
                  {/* Custom Responses */}
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-white">Custom Response Templates</h4>
                    <div className="flex gap-2">
                      <Input
                    ...
                    <div className="flex flex-wrap gap-2">
                      {form.watch("customResponses")?.map((response, index) => (
                        <div key={index} className="bg-blue-600/20 border border-blue-500 rounded-md px-3 py-1 text-sm text-white">
                          {response}
                        </div>
                      ))}
                    </div>
                  ...
                  {/* Trigger Words */}
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-white">Trigger Words</h4>
                    <div className="flex gap-2">
                      <Input
                        value={triggerWord}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {form.watch("customTriggerWords")?.map((word, index) => (
                        <div key={index} className="bg-green-600/20 border border-green-500 rounded-md px-3 py-1 text-sm text-white">
                          {word}
                        </div>
                      ))}
                    </div>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <Button
              ...
              className="bg-purple-600 hover:bg-purple-700"
            >
              {mutation.isPending ? "Saving..." : (isEditing ? "Update Character" : "Create Character")}
            </Button>
          </div>
        </form>
      </Form>
